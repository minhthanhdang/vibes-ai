...
export function designPageFor({ photographs, crops }: ProjectState): ToolDeclaration {
  ...
  return {
    ...
    description: [
      ...
      "It runs its own model, looking at the page it is making, over several rounds — so call it for the page they actually asked for and not to illustrate a point.",
