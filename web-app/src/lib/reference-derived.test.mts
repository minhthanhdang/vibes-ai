...
const { THUMBNAIL_MAX_EDGE, thumbnailBox } = await import("./thumbnail");
const { boardImageVariant } = await import("./moodboard-resolution");
const { DROPPED_IMAGE_MAX_EDGE } = await import("./moodboard-drop");
